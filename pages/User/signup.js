...
import { requestOtp, verifyOtp, createProfile } from '../../services/centralApi';
...
export default function LoginPage() {
  ...
  const [birthTime, setTimeOfBirth] = useState('');
...
console.log('progress', progress);
  ...
  const handleProfileSubmit = async () => {
    ...
    try {
      ...
      Cookies.set('token', profileResponse.data.token, { expires: 7 });
  ...
  const renderProfileSubStep = () => {
    if (profileSubStep === 1) {
      return (
        <div className="w-full max-w-[360px] px-5 pt-8 bg-[#FFF5E6]">
          <div className="mb-6">
    ...
    if (profileSubStep === 2) {
      return (
        <div className="w-full max-w-md px-4 bg-[#FFF8F0]">
    ...
    if (profileSubStep === 3) {
      return (
        <div className="w-full max-w-[375px] px-4 py-6 bg-[#FFF2E2] relative">
          <div className="mb-4">
            <div className="flex justify-between items-center mb-2">
          ...
          <Card className="w-full bg-white shadow-md rounded-xl mt-4">
    ...
    if (profileSubStep === 4) {
      ...
      return (
        <div className="w-full max-w-[375px] px-6 pt-8 pb-20 bg-[#FFF2E2]">
          <div className="mb-4">
            <div className="flex justify-between items-center mb-2">
          ...
          <Card className="w-full bg-white rounded-xl p-6 shadow-sm">
            <Button
              onClick={handleProfilePrevious}
              variant="ghost"
    ...
    if (profileSubStep === 5) {
      return (
        <div className="w-full max-w-md px-4 pt-8 pb-20 bg-[#FFF5E6] relative">
          ...
          <Card className="p-6 shadow-md rounded-xl bg-white">
            ...
            <div className="mb-6">
              ...
              {(placeLat !== null && placeLng !== null) && (
                <p className="text-sm text-[#FF9933] mt-2 text-center">
                  Coordinates: Lat {placeLat.toFixed(4)}, Lng {placeLng.toFixed(4)}
                </p>
              )}
            </div>
            <Button
                ...
                <>
                  ...
                  <div className="space-y-3">
                    <Button
                      ...
                      className="w-full py-6 bg-[#FFB980] hover:bg-[#FFA766] text-white font-medium rounded-lg !rounded-button cursor-pointer"
                    ...
                    <Button
                      ...
                      className={`w-full py-6 font-medium rounded-lg !rounded-button ${
                        countdown > 0 || isResending
                          ? 'bg-[#FFE5CC] text-gray-500 cursor-not-allowed'
