 ...
 useEffect(() => {
  ...
  return (
    <>
      ...
      <Head>
        <title>Weekly Horoscope | All Zodiac Signs | AstroSight</title>
        ...
        <meta property="og:url" content="https://astrosight.ai/horoscope/weekly-horoscope" />
        <link rel="canonical" href="https://astrosight.ai/horoscope/weekly-horoscope" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "Weekly Horoscope | All Zodiac Signs",
