    ...
    <section className="py-3 md:py-10 lg:py-3 bg-gradient-to-b from-astro-light-beige to-white min-h-[calc(100vh-64px)] flex items-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className='text-3xl/8 text-[#3A3026] px-auto font-semibold'><span className="text-[#FF6D3F] text-3xl">AstroAnswer</span>, Transforming Ancient Astrological Wisdom Into Actionable Modern Guidance
          </div>
